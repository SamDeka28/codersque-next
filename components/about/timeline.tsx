...
const timelineEvents = [
  ...
  },
  {
    ...
    icon: "🏆",
    achievements: [
      "Partnered with MPAARS, and BrandWorks",
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-950 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        ...
        >
          {/* Timeline Line */}
          <div className="absolute left-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-purple-500 via-indigo-500 to-blue-500 transform -translate-x-1/2 rounded-full" />
          ...
          {timelineEvents.map((event, index) => (
            <motion.div
              ...
              className={`flex items-center mb-24 last:mb-0 ${index % 2 === 0 ? "flex-row-reverse" : ""}`}
            >

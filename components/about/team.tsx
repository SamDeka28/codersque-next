...
export default function Team() {
  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-b from-purple-50 to-white dark:from-purple-950 dark:to-gray-900 relative overflow-hidden">
      {/* Background elements */}
            ...
            >
              <div className="bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-xl border border-purple-100 dark:border-purple-900/30 group h-full flex flex-col">
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <p className="text-gray-600 dark:text-gray-400 text-sm mb-4 flex-1 line-clamp-3 md:line-clamp-none">
                    {member.bio}
                  </p>

      ...
      <section className="review_section bg_light position-relative">
        <div className="container">
          <div className="section_heading style_4 text-center">
            ...
            <h3 className="heading_title mb-0">What our client says about Us</h3>
          </div>
          <div className="row" style={{ display: "flex", justifyContent: "center" }}>
            ...
            <div className="col col-xl-12 col-lg-12 p-lg-0">
              <div className="review_carousel_4">
                ...
                <div className="testimonial_arrow">
                  <ul className="carousel_arrow unordered_list_center pt-md-0">
                    <li>
                      <button type="button" className="cc1c_left_arrow" onClick={handlePrevClick}>
                        <i className="far fa-arrow-left"></i>
                      </button>
                    </li>
                    <li>
                      <button type="button" className="cc1c_right_arrow" onClick={handleNextClick}>

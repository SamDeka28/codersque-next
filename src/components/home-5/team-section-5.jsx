  ...
  return (
    <section className="team_section section_space_lg">
      <div className="container">
        ...
        <div className="row justify-content-center">
          {
            team_data.slice(0, 4).map((item) => (
              <div className="col col-lg-3 col-md-6 tilt" key={item.id}>
                <div className="team_item style_2">
                  <div className="admin_thumbnail">
                    <div className="thumbnail_wrap">
                      <Image src={item.person} style={{ width: "100%", height: "100%" }} alt=" Team Admin Image" />
                    </div>
                  </div>
        ...
        <div className="btn_wrap text-center pb-0">
...
export default TeamSectionFive;
    ...
    <>
      ...
      <section className="about_section_2">
        <div className="video_widget rounded-0">
          <Image src={video_poster_image} style={{ width: "100%", height: "100%" }} alt="Video Poster Image" />
                  ...
                  <div className="col col-md-6">
                    <div className="iconbox_item text-white">
                      <div className="item_icon">
                        <Image src={icon_eye_white} style={{ width: "auto", height: "auto" }} alt=" Icon Eye White" />
                      </div>

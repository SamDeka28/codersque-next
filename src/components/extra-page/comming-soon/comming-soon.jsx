...
import site_logo from '@assets/images/logo/logo.svg'
  ...
  return (
    <section className="comming_soon_section decoration_wrap mouse_move overflow-hidden">
      <div className="container">
        <div className="site_logo">
          <Link className="site_link" href="/">
            <Image src={site_logo} height={40} alt="Site Logo - Codersque Technologies " />
          </Link>
        </div>
      ...
      <div className="deco_item shape_1 wow fadeInDown" data-wow-delay=".1s">
        <Image className="layer" src={shape_circle} data-depth="0.2" alt="Codersque Technologies - Shape Image" />
      </div>
      <div className="deco_item shape_2 wow fadeInUp" data-wow-delay=".1s">
        <Image className="layer" src={shape_circle_1} data-depth="0.2" alt="Codersque Technologies - Shape Image" />
      </div>
      <div className="deco_item shape_3 wow fadeInRight" data-wow-delay=".1s">
        <Image className="layer" src={shape_1} data-depth="0.2" alt="Codersque Technologies - Shape Image" />
      </div>
      <div className="deco_item shape_4 wow fadeInUp" data-wow-delay=".1s">
        <Image className="layer" src={shape_circle_half_1} data-depth="0.2" alt="Codersque Technologies - Shape Image" />
      </div>
      <div className="deco_item shape_5 wow zoomIn" data-wow-delay=".1s">
        <Image className="layer" src={shape_circle_2} data-depth="0.2" alt="Codersque Technologies - Shape Image" />
      </div>
    </section>
  );
};

        ...
        <div className="container">
          <div className="content_box bg_primary decoration_wrap">
            <div className="row align-items-center">
              <div className="col col-xxl-5 col-xl-6 col-lg-6 order-last">
                <div className="cta_image">
                  <Image src={cta_image_5} style={{ width: "100%", height: "100%" }} alt=" Call To Action Image" />
                </div>
              </div>
            ...
            <div className="deco_item shape_1">
              <Image className="wow fadeInUp" data-wow-delay=".2s" src={shape_4} style={{ width: "100%", height: "100%" }} alt=" Illustration Image" />
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="col col-lg-3 col-md-6">
              <div className="site_logo">
                <Link className="site_link" href="/">
                  <Image src={site_logo_dark} style={{ width: "100%", height: "100%" }} alt="Site Logo -  - Agency Template" />
                </Link>
              </div>
            </div>
            <div className="col col-lg-3 col-md-6">
